...
function subirPorTipo(tipo, id, nombreArchivo, res) {
    ...
    if (tipo === 'trabajadores') {
        ...
        Trabajador.findById(id, (err, trabajador) => {
            ...
            trabajador.save((err, trabajadorActualizado) => {

                trabajadorActualizado.password = 'No permitido';

                return res.status(200).json({
                    ok: true,
                    mensaje: 'Imagen del trabajador actualizada',
